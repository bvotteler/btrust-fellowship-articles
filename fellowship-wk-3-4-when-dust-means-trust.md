...
Another in-development solution is instead of classic HTLCs using [PTLCs](https://bitcoinops.org/en/topics/ptlc/) (Point Time-Locked Contracts). They also require a soft-fork update on Bitcoin to enable Pay to Anchor (P2A) scripts, so something to look out for in future.  
For more details on P2A, Murch has another detailed explanation of what they are meant to do and solve in his [reply on stackexchange](https://bitcoin.stackexchange.com/a/126119).
